...
Netflix Customer Churn Analysis using SQL


## 🎯 Project Objective

The objective of this project is to analyze Netflix customer data using SQL to identify churn patterns, understand customer behavior, and determine the key factors responsible for customer cancellations.
The insights help improve customer retention and reduce churn.
...
DBMS Tools (MySQL Workbench / pgAdmin)
...
## 📊 Key Insights (Short & Clear)

High churn observed among new customers

Basic subscription plans have higher churn

Long-term users are more loyal

Auto-payment reduces churn risk

Region-wise churn patterns exist


## 💡 Business Recommendations

Offer discounts or trials to new customers

Promote annual and auto-renewal plans

Improve engagement for basic plan users

Launch region-specific retention campaigns

Use churn prediction insights for proactive retention
